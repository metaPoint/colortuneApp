...
class Sound : NSObject {
    ...
    */
    func readFileIntoAVPlayer() {
        ...
        let fileURL:NSURL = NSBundle.mainBundle().URLForResource("silence", withExtension: "mp3")!
    ...
    func loadMIDIFile() {
        ...
        var contents:NSURL = NSBundle.mainBundle().URLForResource("animals", withExtension: "mid")!
